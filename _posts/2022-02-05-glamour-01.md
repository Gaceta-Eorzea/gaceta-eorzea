...
Como sabrás, hay piezas de equipo para todas las clases y otras específicas. No podrás glamourear una pieza de “*Discipline of War*” en un *Summoner*, por ejemplo.<br/>
Además, **no podrás glamourear una pieza que sea de mayor nivel o item level que la que lleves equipada**. En los casos en los que te mejora el item level, mejor saca esa pieza del *Glamour Dresser*, póntela y luego ya la volverás a meter en el armario correspondiente cuando te equipes algo mejor.<br/>
...
¿Puedo cambiar el *Glamour* siempre que quiera?<br/>
El *Glamour* lo puedes cambiar siempre y cuando estés **en una ciudad principal** y zonas de housing. En medio del campo no puedes aplicar un glamour a una clase/job. Vamos a verlo.
...
<blockquote>
Vamos a hacer un paréntesis antes de hablar de esto. Tenemos un personaje con varios <i>jobs</i> y, para cambiarnos entre ellos, disponemos de una herramienta muy útil. En la ventana de Character (la <i>C</i> por defecto), a partir del nivel 15 de la MSQ, disponemos de los “<i>Gear Set List</i>” (el icono de la derecha de los tres iconos que tenemos encima del arma), desde donde podemos administrar cómodamente los conjuntos de equipo que utilizamos en los diferentes <i>jobs</i>, guardando y actualizando su configuración.
</blockquote>
