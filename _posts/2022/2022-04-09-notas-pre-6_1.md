...
<blockquote>
Si quieres entender al completo como funciona el sistema de lotería te recomendamos que leas <a href="{{ '/ishgard-housing/' | relative_url }}" target="_blank">el articulo</a> donde lo explicamos al detalle.
</blockquote>
...
<blockquote>
Si quieres mas información de como funcionará el nuevo modo y de los cambios de JcJ podéis leer <a href="{{ '/live-letter-70-2/' | relative_url }}" target="_blank">el articulo</a> donde explicamos la información extensa que dieron el último live letter.
</blockquote>
