...
La **sexta imagen** donde tenéis que **adivinar la ubicación** y usar el **hashtag** [#dondeestaguerreroluz6](https://x.com/hashtag/dondeestaguerreroluz6){:target="_blank"} es:
...
<div class="container card">
    <div class="row">
        <div class="col-xl">
            <a href="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/06/AlejandroBlzque.jpg" data-toggle="lightbox"><img src="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/06/AlejandroBlzque.jpg"></a>
        </div>       
    </div>
    <div class="row">  
        <div class="col-xl">
