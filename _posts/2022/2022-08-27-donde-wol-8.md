---
layout: post
title:  "¿Dónde está el guerrero de la Luz? Parte 8"
author: cecile
categories: [ ffxivesp ]
tags: [ffxivesp, comunidad]
image: assets/images/articles/comunidad/donde-wol/portada.jpg
description: "¿Dónde está el guerrero de la Luz? Parte 8"
featured: false
hidden: false
---
...
- El tweet tiene que **citar** a [@GacetaEorzea](https://x.com/GacetaEorzea){:target="_blank"} y **incluir los hastag** [#FFXIVESP_BENÉFICO](https://x.com/hashtag/FFXIVESP_BENÉFICO){:target="_blank"} y **#dondeestaguerreroluzNUMERO DE IMAGEN** en este caso seria [#dondeestaguerreroluz8](https://x.com/hashtag/dondeestaguerreroluz8){:target="_blank"}
...
<p align="center"><img src="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/08/ejemplo8.jpg" width="50%"></p>

La **octava imagen** donde tenéis que **adivinar la ubicación** y usar el **hashtag** [#dondeestaguerreroluz8](https://x.com/hashtag/dondeestaguerreroluz8){:target="_blank"} es:
...
<div class="container card">
    <div class="row">
        <div class="col-xl">
            <a href="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/08/08.jpg" data-toggle="lightbox"><img src="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/08/08.jpg"></a>
        </div>       
    </div>
</div>
...
En esta ocasión **nuestro WoL estaba en Terncliff**, aquí dejamos las imágenes que han acertado.
