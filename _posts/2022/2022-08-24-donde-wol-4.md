...
La **cuarta imagen** donde tenéis que **adivinar la ubicación** y usar el **hashtag** [#dondeestaguerreroluz4](https://x.com/hashtag/dondeestaguerreroluz4){:target="_blank"} es:
...
<div class="container card">
    <div class="row">
        <div class="col-xl">
            <a href="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/04/AlejandroBlzque.jpg" data-toggle="lightbox"><img src="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/04/AlejandroBlzque.jpg"></a>
        </div>       
    </div>
    <div class="row">  
        <div class="col-xl">
...
<div class="container card">
    <div class="row">
        <div class="col-xl">
            <a href="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/04/ThorelisAsgard1.jpg" data-toggle="lightbox"><img src="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/04/ThorelisAsgard1.jpg"></a>
        </div>       
    </div>
    <div class="row">  
        <div class="col-xl">
