...
- La gaceta pondrá una **imagen** que podréis ver **debajo de estas instrucciones** donde veréis a nuestro guerrero de la luz junto a algunos NPCs.
...
- El twitter tiene que **citar** a [@GacetaEorzea](https://twitter.com/GacetaEorzea){:target="_blank"} y **incluir los hastag** [#beneficoxxxxx](https://twitter.com/hashtag/beneficoxxxxx){:target="_blank"} **#donde-esta-guerrero-luz-NUMERO DE IMAGEN** en este caso seria [#donde-esta-guerrero-luz-1](#donde-esta-guerrero-luz-1){:target="_blank"}
...
**Ejemplo de Twitter para participar**:

<p align="center"><img src="{{ site.baseurl }}/assets/images/articles/comunidad/donde-wol/ejemplo.jpg" width="50%"></p>

La **primera imagen** donde tenéis que **adivinar la ubicación** y usar el **hashtag** [#donde-esta-guerrero-luz-1](#donde-esta-guerrero-luz-1){:target="_blank"} es:
