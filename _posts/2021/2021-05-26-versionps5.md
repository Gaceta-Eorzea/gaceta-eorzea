...
El parche 5.55 también marca el punto final del Shadowbringers expansión, agregando contenido adicional al juego principal, así como las líneas de misiones de YoRHa: Dark Apocalypse y Save the Queen. Puedes encontrar un resumen de lo que trae el parche 5.55 en el <a href="{{ '/resumen-5-55/' | relative_url }}" class="eorzeadb_link" target="_blank">siguiente enlace</a>
