...
Una semana mas [Kaiyoko Star](https://x.com/kaiyokostar){:target="_blank"} ha publicado la solución para el Fashion Report, la cual podeis ver a continuacion.

<blockquote>
Esta semana os recomendamos completar el fashion report el lunes 19 ya que es cuando se habilita <a href="{{ '/make-it-rainn/' | relative_url }}" target="_blank">el evento</a> del 50% de MGP extra.
</blockquote>
