...
Cuando nuestro asistente tiene una clase o profesión y el equipo requerido, estará preparado para mandarlo de misiones, las cuales nos pediran **2 Ventures** cada ves que les enviemos esto lo haremos tras elegir la opción ***Assign venture*** y serán distintas dependiendo la profesión que hayas elegido para tu asistente.
...
- Exploraciones, duran 18 horas y proporcionan mucha experiencia, las usaremos para subir de nivel a nuestros asistentes. Estas misiones a ciertos niveles tiene probabilidad de proporcionar ademas objetos especiales como mascotas de acompañamiento.
  ...
  - ***Highland Exploration* - *Minero***: **Piezas de plata o Bronze** y objetos aleatorios de minería.
  - ***Woodland Exploration* - *Botanista***: **Piezas de plata o Bronze** y objetos aleatorios de de botanismo.
  - ***Waterside Exploration* - *Pescador***: **Piezas de plata o Bronze**  y objetos aleatorios de pesca.
...
* ***Botany***: Traerán objetos de botanismo.
...
### Como vender objetos en el *Market Board* (Tablón del Mercado) utilizando tu As
